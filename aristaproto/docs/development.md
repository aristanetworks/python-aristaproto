...
This page targets the aristaproto maintainers.
...
!!! warning
    These proto files are written with the `proto2` syntax, which is not supported by aristaproto. For the compiler to
